...
description: "Every Resource item in the ServUO source (221), with art, item IDs and weights."
status: source-verified
generated: true
sources:
  - "servuo: Scripts/Items/Resource"
...
Auto-generated catalog of every concrete item class under `Scripts/Items/Resource/` (221 items). Icons are static art from the client; item IDs are the resolved ServUO `ItemID`.
