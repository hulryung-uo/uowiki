...
description: "Every Containers item in the ServUO source (120), with art, item IDs and weights."
status: source-verified
generated: true
sources:
  - "servuo: Scripts/Items/Containers"
...
Auto-generated catalog of every concrete item class under `Scripts/Items/Containers/` (120 items). Icons are static art from the client; item IDs are the resolved ServUO `ItemID`.
