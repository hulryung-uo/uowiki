---
title: "Quest Items"
description: "Every Quest Items item in the ServUO source (174) \u2014 items tied to quests \u2014 grouped by the expansion era it was introduced in, with art, item IDs and weights."
...
Auto-generated catalog of every Quest Items — items tied to quests (174 items), **grouped by the game era each was introduced in** (oldest first). Era is derived from the ServUO craft definitions; items with no determinable era are listed last. Icons are static client art.

## Mondain's Legacy (ML)  *(1)*
