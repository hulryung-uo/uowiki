---
title: "Quest Items"
description: "Every Quest item in the ServUO source (194), with art, item IDs and weights."
status: source-verified
generated: true
sources:
  - "servuo: Scripts/Items/Quest"
...
Auto-generated catalog of every concrete item class under `Scripts/Items/Quest/` (194 items). Icons are static art from the client; item IDs are the resolved ServUO `ItemID`.
